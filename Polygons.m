        ...
        %       -0.0044 -0.004;];
          ...
          %     -0.0084 -0.004;];
           ...
           %}
            ...
            outOfBoundsPolys4BIF(1,:,:) = [-0.002644437 0.001502081;
-0.0045 -0.003;
-0.005 -0.001;
-0.004 0.001502081];
            outOfBoundsPolys4BIF(2,:,:) = [-0.004557854 0.006121479;
-0.002644437 0.001502081;
-0.004 0.001502081;
-0.0055 0.0065];
            outOfBoundsPolys4BIF(3,:,:) = [-0.003633975 0.006504162;
-0.004557854 0.006121479;
-0.0055 0.0065;
-0.003333975 0.007404162];
            outOfBoundsPolys4BIF(4,:,:) = [-0.001851084 0.002110843;
-0.003633975 0.006504162;
-0.003333975 0.007404162;
-0.001551084 0.003010843];
            outOfBoundsPolys4BIF(5,:,:) = [0.002516157 0.003956694;
-0.001851084 0.002110843;
-0.001551084 0.003010843;
0.002116157 0.004656694];
            outOfBoundsPolys4BIF(6,:,:) = [0.004429574 0.008576092;
0.002516157 0.003956694;
0.002116157 0.004656694;
0.004129574 0.009276092];
            outOfBoundsPolys4BIF(7,:,:) = [0.005353453 0.008193409;
0.004429574 0.008576092;
0.004129574 0.009276092;
0.006053453 0.008693409];
            outOfBoundsPolys4BIF(8,:,:) = [0.003507602 0.003826168;
0.005353453 0.008193409;
0.006053453 0.008693409;
0.004207602 0.004226168];
            outOfBoundsPolys4BIF(9,:,:) = [0.007900921 0.002043277;
0.003507602 0.003826168;
0.004207602 0.004226168;
0.007800921 0.002843277];
            outOfBoundsPolys4BIF(10,:,:) = [0.01264254 0.0036298;
0.007900921 0.002043277;
0.007800921 0.002843277;
0.01314254 0.0044298];
            outOfBoundsPolys4BIF(11,:,:) = [0.012959844 0.002681477;
0.01264254 0.0036298;
0.01314254 0.0044298;
0.013759844 0.002181477];
            outOfBoundsPolys4BIF(12,:,:) = [0.008509683 0.001249924;
0.012959844 0.002681477;
0.013759844 0.002181477;
0.009609683 0.001];
            outOfBoundsPolys4BIF(13,:,:) = [0.010644161 -0.002909076;
0.008509683 0.001249924;
0.009609683 0.001;
0.011844161 -0.003409076];
            outOfBoundsPolys4BIF(14,:,:) = [0.009749227 -0.003355274;
0.010644161 -0.002909076;
0.011844161 -0.003409076;
0.009249227 -0.004355274];
            outOfBoundsPolys4BIF(15,:,:) = [0.007518238 0.001119398;
0.009749227 -0.003355274;
0.009249227 -0.004355274;
0.007118238 0.000219398];
            outOfBoundsPolys4BIF(16,:,:) = [0.00289884 0.003032815;
0.007518238 0.001119398;
0.007118238 0.000219398;
0.00289884 0.002032815];
            outOfBoundsPolys4BIF(17,:,:) = [-0.001720557 0.001119398;
0.00289884 0.003032815;
0.00289884 0.002032815;
-0.000720557 0.000319398];
            outOfBoundsPolys4BIF(18,:,:) = [-0.003633975 -0.0035;
-0.001720557 0.001119398;
-0.000720557 0.000319398;
-0.002533975 -0.0035];
            outOfBoundsPolys4BIF(19,:,:) = [-0.001720557 -0.008119398;
-0.003633975 -0.0035;
-0.002533975 -0.0035;
-0.000650557 -0.009019398];
            outOfBoundsPolys4BIF(20,:,:) = [-0.002644437 -0.008502081;
-0.001720557 -0.008119398;
-0.000650557 -0.009019398;
-0.003244437 -0.009402081];
            outOfBoundsPolys4BIF(21,:,:) = [-0.0045 -0.004;
-0.002644437 -0.008502081;
-0.003244437 -0.009402081;
-0.005 -0.005];
            outOfBoundsPolys4BIF(22,:,:) = [-0.0095 -0.004;
-0.0045 -0.004;
-0.005 -0.005;
-0.01 -0.005];
            outOfBoundsPolys4BIF(23,:,:) = [-0.0095 -0.003;
-0.0095 -0.004;
-0.01 -0.005;
-0.01 -0.002];
            outOfBoundsPolys4BIF(24,:,:) = [-0.0045 -0.003;
-0.0095 -0.003;
-0.01 -0.002;
-0.005 -0.001];
            ...
            obj.hardCodedOrthogonalWallContacts{4} = [0.924550439 -0.381059688;
