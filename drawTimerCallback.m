function drawTimerCallback(app)
    ...
    rotatedMagLine = ([cosd(app.rotation), sind(app.rotation); -sind(app.rotation), cos(app.rotation)] * [0,app.X1TmGauge.Value./(app.maxForce.*75) ; 0,app.Y1TmGauge.Value./(app.maxForce.*75)])';
