...
yStartDist = [98.8, 100, 92.2;94.4, 98.8, 92.6;91.4, 94.4, 89;95, 91.6, 82.4];
...
SEStartDist = [0.8, 0, 2.640706976;1.146976702, 0.611010093, 2.441311123;2.733333333, 1.107549848, 3.058685266;1.406334874, 3.109841011, 3.474350459];
...
plot10 = errorbar(axes4, [0.005,1,1.5,2], yStartDist(:,2), SEStartDist(:,2),'square-','MarkerSize',4,'MarkerEdgeColor','black','MarkerFaceColor','blue');
plot15 = errorbar(axes4, [0.005,1,1.5,2], yStartDist(:,3), SEStartDist(:,3),'<-.','MarkerSize',4,'MarkerEdgeColor','black','MarkerFaceColor','magenta');
plot1.Color = 'black';
plot2.Color = 'black';
plot3.Color = 'black';
plot05.Color = 'red';
