...
yErrFlowVelocity = [0.78,0.783836718,1.970177657,5.983343547,7.300547925,8.688498144,11.06455602,13.62116001,7.40605158,19.04021008,12.60794987,12.73013747];
...
yErrsplit = [0,6.75384335,11.46779839,7.462573283,5.601035619,5.581541006,8.851417966,20.26209269,13.56880245,11.55023809,13.08417365,16.66720132];
...
yErrForceLimit = [0,6.502953175,2.50031998,2.464224016,2.498319435,0.996192752];
...
hold on
plot1b = plot(axes1a,yCentreMass(2,:),ySIM(2,:) ,'square-','MarkerEdgeColor','black','MarkerSize',4,'MarkerFaceColor','red','color','red');
hold on
